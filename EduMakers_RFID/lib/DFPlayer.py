...
class DFPlayer(object):
  ...
  def __init__(self,uart=None,media=None,volume=50,eq=None,latency=0.100): #latency originally set to .1
    if uart is None:
  ...
  def _read_data(self):
    ...
    if self._uart.in_waiting:
      ...
      if buf is not None and \
        ...
        if data != dataPrev and data is not None:
          dataPrev = data
          count+=1
        return (cmd, data)
      return None
